...
export default function EARPage() {
 ...
 <label className="text-xs font-bold text-slate-500 capitalize tracking-wide flex items-center gap-1.5">
 ...
 <span className={`inline-flex px-1 py-0.5 rounded text-[9px] font-bold border capitalize tracking-wide ${
 ...
 <p className="text-[9px] text-slate-400 font-bold capitalize">{user?.position}</p>
 </div>
 </div>
 </td>
 ...
 <span className="text-[9px] font-black text-emerald-600 capitalize tracking-wide">{real.progress}% SLSE</span>
 </div>
 </td>
 <td className="px-4 py-2 whitespace-nowrap">
 <div className="flex items-center gap-2">
