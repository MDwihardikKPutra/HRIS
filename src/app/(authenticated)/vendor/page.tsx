      ...
      >
        <div className="space-y-4">
          ...
          <div className="space-y-1.5">
            ...
            <input type="text" placeholder="INV-2023-XXXX" className="w-full px-4 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-sm focus:outline-none focus:border-indigo-400 focus:bg-white transition-all font-medium " />
          </div>
          <div className="space-y-1.5">
          ...
          <div className="space-y-1.5">
            ...
            <textarea rows={3} placeholder="Pembayaran termin 1 untuk pengadaan..." className="w-full px-4 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-sm focus:outline-none focus:border-indigo-400 focus:bg-white transition-all resize-none "></textarea>
          </div>
        </div>
      </Modal>
    </div>
