          ...
          <table className="w-full text-xs">
            <thead>
              <tr className="bg-slate-50/50 border-b border-slate-100 font-semibold text-slate-500 uppercase tracking-widest text-[10px]">
                <th className="text-left py-2.5 px-4 font-bold">Pemilik Rencana</th>
                <th className="text-left py-2.5 px-4 font-bold">Proyek & Target</th>
                <th className="text-left py-2.5 px-4 hidden md:table-cell font-bold">Tenggat Waktu</th>
                    ...
                    <td className="py-2.5 px-4">
                      <div className="flex items-center gap-2.5">
                        ...
                        <div>
                          ...
                          <p className="text-[10px] text-slate-400 font-bold uppercase tracking-tight">#{wp.planNumber}</p>
                        </div>
                      </div>
                    </td>
                    <td className="py-2.5 px-4">
