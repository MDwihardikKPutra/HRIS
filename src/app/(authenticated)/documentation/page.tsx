...
import { Fingerprint, Book, ShieldCheck, Zap, Server, Users } from"lucide-react";
...
export default function DocumentationPage() {
 ...
 <div className="inline-flex items-center gap-1 px-2 py-1 bg-indigo-50 rounded-lg text-indigo-600 text-[9px] font-bold tracking-wide mb-4 border border-indigo-100">
 ...
 <span className="text-[9px] text-slate-400 font-bold tracking-wide mt-1">Versi Sistem</span>
 </div>
 ...
 <span className="text-[9px] text-slate-400 font-bold tracking-wide mt-1">Status Server</span>
 </div>
 </div>
 </div>
 </div>
 ...
 <h2 className="text-[12px] font-bold text-slate-500 capitalize tracking-wide flex items-center gap-3">
 <ShieldCheck className="w-5 h-5 text-indigo-600"/>
 Alur Operasional
 </h2>
 <span className="px-3 py-1.5 bg-slate-50 text-slate-500 text-[10px] font-bold text-slate-500 capitalize tracking-wide rounded-lg border border-slate-200">Protokol Dasar</span>
 </div>
 ...
 <div>
 <h3 className="text-xs font-bold text-slate-800 capitalize tracking-wide mb-2">Pengajuan</h3>
 ...
 <div>
 <h3 className="text-xs font-bold text-slate-800 capitalize tracking-wide mb-2">Verifikasi</h3>
 <p className="text-[12px] text-slate-500 leading-relaxed font-medium">
 ...
 <div>
 <h3 className="text-xs font-bold text-slate-800 capitalize tracking-wide mb-2">Finalisasi</h3>
 <p className="text-[12px] text-slate-500 leading-relaxed font-medium">
 ...
 <h2 className="text-[12px] font-bold text-slate-500 capitalize tracking-wide">
 Spesifikasi Sistem
 </h2>
 </div>
 ...
 <span className="text-[12px] text-slate-500 font-bold capitalize tracking-wide">Base Engine</span>
 <span className="text-xs text-indigo-600 font-bold tabular-nums bg-indigo-50 px-2 py-1 rounded-md border border-indigo-100">Next.js 16.2</span>
 </div>
 <div className="flex justify-between items-center border-b border-slate-100 pb-2.5">
 <span className="text-[12px] text-slate-500 font-bold capitalize tracking-wide">Design Core</span>
 <span className="text-xs text-slate-700 font-bold tabular-nums">Tailwind v4.0</span>
 </div>
 <div className="flex justify-between items-center border-b border-slate-100 pb-2.5">
 <span className="text-[12px] text-slate-500 font-bold capitalize tracking-wide">Basis Data</span>
 <span className="text-xs text-slate-700 font-bold tabular-nums">JSON / Dummy</span>
 </div>
 <div className="flex justify-between items-center border-b border-slate-100 pb-2.5">
 <span className="text-[12px] text-slate-500 font-bold capitalize tracking-wide">Node Env</span>
 <span className="text-xs text-emerald-600 font-bold tabular-nums bg-emerald-50 px-2 py-1 rounded-md border border-emerald-100">LTS 20.x.x</span>
 </div>
 </div>
 </section>
 </div>
 ...
 <h2 className="text-[10px] font-bold text-slate-500 capitalize tracking-wide mb-5 flex items-center gap-2">
...
"Standard Keamanan"
 ...
 <button className="w-full mt-4 py-2 bg-white border border-slate-200 text-slate-600 hover:border-indigo-600 hover:bg-indigo-600 hover:text-white text-[10px] font-bold rounded-lg transition-all active:scale-95 relative z-10">
 Buat Tiket Bantuan
 </button>
 </div>
 </div>
